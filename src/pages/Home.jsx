...
const Home = () => {
  ...
  const mahsulotniSavatchagaQoshish = (product) => {
            ...
            return(
              <li className='shadow-md relative p-2 rounded  h-[349px]' key={e.id}>
                ...
                {/* img */}
                  ...
                  <button onClick={() => mahsulotniSavatchagaQoshish(e)} className='text-base flex flex-col items-center w-full text-katalog border-2 border-katalog p-2 rounded'>В корзину</button>
                </Link>
              </li>
